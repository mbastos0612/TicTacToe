class Node {
  ...
  int rutaGanadora;//Este nodo se dirige a una hoja de 0 pierde, 1 empate, 2 gana
  int[][] estadoActual= new int[3][3]; //Estado actual de la matriz
  public ArrayList<Node> nodosHijos = new ArrayList<Node>();
  

  Node(int key, int parentKey, int[][] estadoActual) {
  ...
  public String toString() {
    ...
    return " Nodo " + key +" soy hijo de " +parentKey;
  ...
  public void agregarHijo(Node nodoAAgregar){
      this.nodosHijos.add(nodoAAgregar);
